  ...
  if (loading) {
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.headerTitle, { backgroundColor: '#333', width: '50%', height: 30, borderRadius: 4, marginBottom: 20 }]} />

        {/* Skeleton for Trending TV Shows */}
        <FlatList
        ...
        {[1, 2, 3].map((sectionIndex) => (
          <View key={sectionIndex} style={styles.genreSection}>
            <View style={[styles.genreHeader, { backgroundColor: '#333', width: '60%', height: 25, borderRadius: 4, marginBottom: 10 }]} />
            <FlatList
              data={[1, 2, 3, 4]} // Dummy data for skeleton show items
              horizontal
              showsHorizontalScrollIndicator={false}
              contentContainerStyle={styles.genreShowListContainer}
              renderItem={() => (
                <View style={[styles.showItem, { backgroundColor: '#333' }]}>
